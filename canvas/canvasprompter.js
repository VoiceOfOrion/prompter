var PROMPTER = function (options) {
	...
	var keys = options.keys || {
		...
		89: "flipVertical", // Y
		32: "stopStart", // Пробел
		39: "getScript", // Стрелка вправо
		109: "decreaseFontSize", // -
		107: "increaseFontSize", // +
		40: 'increaseSpeed', // Стрелка вниз
		38: 'decreaseSpeed', // Стрелка вверх
		82: 'resetScript', // R
		//development
		83: 'scriptify',
		70: 'maximize' // F
	...
	var script = scriptify("I'm Crystal Merritt, Operations Director at Streamsy. Previously I worked in the non-profit sector for 10 years. Streamsy works with government agencies to make public meetings accessible to anyone who wants to participate. My passion is to make professional live streaming of public meetings affordable and available. My company Streamsy was developed to help organizations build live streaming systems by providing training, technology, and expertise. When organizations implement live streaming systems, public meetings truly become public. My experience has been that, with guidance and direction, organizations can create and manage a streaming system that is cost-effective. We provide the knowledge and know how to create a sustainable live streaming system. Our goal is to make every public meeting available live and easily accessible to anyone who wants to participate. We believe this whether it is a small local issue being discussed or a large governmental hearing to decide legislation. We accomplish our goal by providing adequate live streaming training and knowledge to employees working in the public sector. Have you ever attended a public meeting?");
	...
	var draw = function(){
		...
		for(var line in scriptText){
			...
			//Показываем только те строки, которые в данный момент на экране
	...
	function scriptify(scriptString){
		...
		scriptString = scriptString || "Суфлёр: текст не загружен...";
